...
postgresql script to create the required primary keys and indices within the OMOP common data model, version 5.3

last revised: 21-Jul-2021

author:  Patrick Ryan, Clair Blacketer, Marc Suchard
...
SET search_path TO @cdm_database_schema;
